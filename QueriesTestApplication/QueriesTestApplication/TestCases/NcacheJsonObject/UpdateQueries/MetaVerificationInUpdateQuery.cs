...
namespace QueriesTestApplication
{
    public class MetaVerificationInUpdateQuery
    {
        ...
        public MetaVerificationInUpdateQuery()
        {
            cache = CacheManager.GetCache(Common.CacheName);
            _report = new Report(nameof(MetaVerificationInUpdateQuery));
        ...
        public void UpdateGroup()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product Set-meta $group$ = @group where Category = @beverages";
        ...
        public void UpdateGroupWithSomeSetAttributes()
        {
            ...
            {
                cache.Clear();
               // PopulateCache(); todo fix why the items in cachea re removed after this call
                PopulateCacheWithMeta();
        ...
        public void UpdateTag()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product Set-meta $tag$ = @tagArray where Category = @beverages";

                QueryCommand queryCommand = new QueryCommand(query);
                queryCommand.Parameters.Add("@beverages", catagory);
                queryCommand.Parameters.Add("@tagArray", tagsArray);
        ...
        public void UpdateNamedTag()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product Set-meta $NamedTag$ = @namedTags where Category = @beverages";

                QueryCommand queryCommand = new QueryCommand(query);
                queryCommand.Parameters.Add("@beverages", catagory);
                queryCommand.Parameters.Add("@namedTags", namedTags);
        ...
        public void RemoveGroup()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product REMOVE-META $group$ = @group where Category = @beverages";

                QueryCommand queryCommand = new QueryCommand(query);
                queryCommand.Parameters.Add("@beverages", catagory);
                queryCommand.Parameters.Add("@group", _groupName);
        ...
        public void RemoveGroupWithSomeSetAttributes()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product Set this.Name = @tea, this.Order.ShipCity = @lahore Add this.Order.Type = @important  remove-meta $group$ = @group where Category = @beverages";
                QueryCommand queryCommand = new QueryCommand(query);
                queryCommand.Parameters.Add("@beverages", "Beverages");
                queryCommand.Parameters.Add("@tea", teaName);
                queryCommand.Parameters.Add("@important", importance);
        ...
        public void RemoveTagThatDoesnotExist()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product remove-meta $tag$ = @tagArray where Category = @beverages";
        ...
        public void RemoveNamedTag()
        {
            ...
            try
            {
                ...
                string query = "Update  Alachisoft.NCache.Sample.Data.Product Remove-meta $NamedTag$ = @namedTags where Category = @beverages";
